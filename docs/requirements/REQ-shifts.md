...
| REQ-SHF-016 | Managers can remove a registered bartender from a shift's bartender list (v.1: removal only — manual assignment by manager is v.2) | High | todo | US-011 |
| REQ-SHF-017 | Bartenders can view shift details from "המשמרות שלי" in a detail popup | High | todo | US-005, US-020 |
